...
public class GoToMidPosition extends Command {

	private int conePosition = RobotContainer.elevator.getMidConePosition();
	private int cubePosition = RobotContainer.elevator.getMidCubePosition();
	private boolean isCone;
	
	private int desiredPosition;


	public GoToMidPosition() {
