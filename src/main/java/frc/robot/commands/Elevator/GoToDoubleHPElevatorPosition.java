...
public class GoToDoubleHPElevatorPosition extends Command {

	private int conePosition = RobotContainer.elevator.getDoubleHPConePosition();
	private int cubePosition = RobotContainer.elevator.getDoubleHPCubePosition();
